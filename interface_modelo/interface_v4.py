...
btn_selecionar = tk.Button(frame_space, text="Selecionar Imagem", command=selecionar_arquivo, bg="#FFC107", fg="black", font=("Arial", 12, "bold"), borderwidth=2, relief="raised")
btn_selecionar.grid(row=0, column=0, padx=10, pady=10)

# Botão para iniciar a detecção
btn_detectar = tk.Button(frame_space, text="Iniciar Detecção", command=iniciar_deteccao, bg="#FF5722", fg="white", font=("Arial", 12, "bold"), borderwidth=2, relief="raised")
btn_detectar.grid(row=0, column=1, padx=10, pady=10)

# Botão para limpar o caminho e as imagens carregadas
btn_limpar = tk.Button(frame_space, text="Limpar Tela", command=limpar, bg="#795548", fg="white", font=("Arial", 12, "bold"), borderwidth=2, relief="raised")
...
root.update_idletasks()
root.geometry('1350x850')  # Defina um tamanho inicial para a janela
centralizar_janela()
